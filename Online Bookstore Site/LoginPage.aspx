...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<table style="width:100%;">
        ...
        <asp:Image ID="Image1" runat="server" Height="85px" ImageUrl="~/ksu logo.png" style="text-align: center" Width="411px" />
                ...
                <td class="auto-style14">
                    <asp:HyperLink ID="LoginLabel" runat="server">Login</asp:HyperLink>
                </td>
                <td class="auto-style13">
                    <asp:Button ID="LogoutButton" runat="server" BackColor="White" BorderStyle="None" Font-Names="Times New Roman" Font-Size="Medium" OnClick="LogoutButton_Click" Text="Logout" />
                </td>
...
&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="TeacherDropDownList" runat="server" Height="16px" Width="146px">
        ...
        <div class="auto-style15">
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td class="auto-style23"><strong>Login Below</strong></td>
                ...
                <tr>
                    ...
                    <td class="auto-style20">
                        <asp:Label ID="UsernameError" runat="server" ForeColor="Red" Text="*Username does not exist*"></asp:Label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style20">
                        <asp:Label ID="PasswordError" runat="server" ForeColor="Red" Text="*Password does not match username*"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">&nbsp;</td>
